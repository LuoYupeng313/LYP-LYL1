...
/**
 * gPTP-capable TLV for IEEE 802.1AS-2020
 * Used to advertise asCapable state to the network
 */
struct gptp_capable_tlv {
	Enumeration16 type;        /* 0x8000 - TLV_ORGANIZATION_EXTENSION_DO_NOT_PROPAGATE */
	UInteger16    length;      /* 8 */
	Octet         id[3];       /* IEEE 802.1 Committee OUI: 00-80-C2 */
	Octet         subtype[3];  /* 0x000001 for gPTP-capable */
	UInteger8     flags;       /* bit 0: logGptpCapableMessageInterval if set */

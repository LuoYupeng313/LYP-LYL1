...
/**
 * Request servo reset due to sync interval exceed
 * @param c  The clock instance.
 */
 ...
 * @return   1 if restart was detected, 0 otherwise.
 */
...
/**
 * Check if master restart was detected for this clock instance.
 * @param c  The clock instance.
 * @return   1 if master restart was detected, 0 otherwise.
 */
...
/**
 * Obtain the slave servo stable shared memory from a clock.
 * @param c  The clock instance.
 * @return   A pointer to the slave servo stable shared memory.
 */
